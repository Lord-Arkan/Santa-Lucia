    ...
    <DashboardLayout>
        <div class="grid gap-6">
            <div class="flex items-center justify-between">
                ...
                <button type="button" class="rounded-2xl bg-gradient-to-r from-teal-400 to-cyan-400 px-4 py-2 text-sm font-black text-slate-950 shadow-lg hover:opacity-95" @click="openCreate">
                    + Nuevo
                </button>
            </div>
            ...
            <div v-if="props.specialties.links" class="flex items-center justify-between px-2 py-4">
