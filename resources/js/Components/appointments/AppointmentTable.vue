            ...
            <table class="min-w-[820px] w-full text-left">
                ...
                <tbody class="divide-y divide-white/10">
                    <tr v-for="a in props.appointments" :key="a.appointment_id" class="transition hover:bg-white/[0.03]">
                        ...
                        <td class="px-5 py-4"><span :class="['rounded-full px-3 py-1.5 text-xs font-black', a.status === 'SCHEDULED' ? 'bg-emerald-300/10 text-emerald-200' : 'bg-rose-300/10 text-rose-200']">{{ a.status_label ?? a.status }}</span></td>
                        <td class="px-5 py-4">
